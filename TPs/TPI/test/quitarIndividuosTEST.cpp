...
TEST(quitarIndividuosTEST, noCambiaNada) {
    eph_h th = {
            {22013,2020,3,319938,629513,1,41,0,1,4,3,2},
            {20101,2020,3,315773,625696,1,41,0,1,2,2,2},
            {22010,2020,3,315773,625696,1,41,0,1,2,2,2},
    };

    eph_i ti = {
            {22013,2020,1,0,3,1,65,1,2,15000,8},
            {22013,2020,7,0,3,2,22,0,0,10000,10},
            {22013,2020,9,0,3,1,9,0,0,0,10},
            {22013,2020,10,0,3,2,9,0,0,0,10},
            {22013,2020,11,0,3,2,18,0,0,0,10},
            {22013,2020,12,0,3,2,17,0,0,0,10},
            {22010,2020,1,0,3,2,46,1,3,3900,0},
            {20101,2020,2,0,3,1,18,0,3,6000,10},
    };
