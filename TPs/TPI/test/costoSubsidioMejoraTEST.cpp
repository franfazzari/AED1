...
TEST(costoSubsidioMejoraTEST, ningunPropietarioTieneCasaChica) {
    eph_h th = {
            {15726,2018,3,336630,646391,1,40,1,1,3,4,2},     // propia, alcanzan
            {188,2018,3,325187,635309,1,40,0,1,3,4,2},       // propia, alcanzan
            {11867,2018,3,320329,630940,1,43,1,1,3,2,2},     // propia, alcanzan
            {14914,2018,3,321889,631412,2,43,0,2,3,1,2},     // no propia, no alcanzan
    };
