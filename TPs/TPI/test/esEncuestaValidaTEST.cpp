...
TEST(esEncuestaValidaTEST, noEsMatrizTH) {

    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  41, 0,  1,  3,  1,  2},
                {31117, 2020,   3,  332870, 642475, 3,  40, 0,  1,  6,  6,  2},
                {22866, 2020,   3,  317157, 627217, 2,  42, 1,  1,  2,  2,  2},
                {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  3,  1}};
...
TEST(esEncuestaValidaTEST, validaMatrizLongitud1) {
...
TEST(esEncuestaValidaTEST, invalidaRegionFueraRango2) {
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  2, 0,  1,  3,  1,  2}};
    eph_i ti = {{22114, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  10}};

    EXPECT_FALSE(esEncuestaValida(th, ti));
}

TEST(esEncuestaValidaTEST, invalidaRegionFueraRango45) {
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  45, 0,  1,  3,  1,  2}};
    eph_i ti = {{22114, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  10}};

    EXPECT_FALSE(esEncuestaValida(th, ti));
}

TEST(esEncuestaValidaTEST, invalidaRegionMenorA1) {
    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  0, 0,  1,  3,  1,  2}};
    eph_i ti = {{22114, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  10}};
