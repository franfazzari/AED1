...
TEST(histHabitacionalTEST, ningunaEnRegion) {
...
TEST(histHabitacionalTEST, noHayNingunaCasa) {

//                                          Región  #Habitaciones
//                                            v      v
    eph_h th = {{22010,2020,3,319938,629513,1,41,0,2,4,3,2},
                {20101,2020,3,315773,625696,1,41,0,2,2,2,2},
                {20089,2020,3,315920,625586,1,41,0,2,2,1,2},
                {31281,2020,3,332103,642547,2,40,0,2,1,1,2}, // esta es de otra region
                {18229,2020,3,326496,636045,3,41,0,2,3,2,2},
                {20984,2020,3,314623,624502,1,41,0,2,4,3,2},
                {20650,2020,3,315426,625486,1,41,0,2,4,2,2}};
